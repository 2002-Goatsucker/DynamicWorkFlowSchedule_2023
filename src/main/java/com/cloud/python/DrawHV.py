...
if __name__ == "__main__":
    ...
    data5 = np.loadtxt("C:\\Users\\徐璟源\\Desktop\\git repository\\DynamicScheduling_2023\\src\\main\\resources\\result\\result_dmga.txt")
    ...
    plt.title("Montage_100 80ins 0.15severity")
    plt.savefig("C:\\Users\\徐璟源\\Desktop\\实验数据\\Montage\\0.15\\fig.png")
    plt.show()